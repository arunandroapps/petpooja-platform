...
import { LayoutDashboard, Users, Store, Network, CreditCard, BarChart3, Headphones, Settings, LogOut, Building2 } from 'lucide-react';
      ...
      <aside className="w-60 shrink-0 bg-gradient-to-b from-sa-700 to-sa-900 text-white flex flex-col">
        ...
        <div className="p-4 border-t border-white/10">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center font-semibold text-sm">{currentUser?.name.charAt(0)}</div>
