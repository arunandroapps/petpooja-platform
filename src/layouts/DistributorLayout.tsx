    ...
    <div className="flex h-screen overflow-hidden">
      <aside className="w-60 shrink-0 bg-gradient-to-b from-dist-700 to-dist-900 text-white flex flex-col">
        ...
        <div className="p-4 border-t border-white/10">
          <button onClick={() => nav2('/dist/owners')} className="w-full mb-3 flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 rounded-lg px-3 py-2 text-sm font-medium">
