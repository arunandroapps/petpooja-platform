    ...
    <div className="flex h-screen overflow-hidden">
      <aside className="w-60 shrink-0 bg-gradient-to-b from-own-700 to-own-900 text-white flex flex-col">
        ...
        <div className="shrink-0 p-3 border-t border-white/10 space-y-2">
          <button onClick={() => nav2('/own/restaurants')} className="w-full flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 rounded-lg px-3 py-2 text-sm font-medium">
