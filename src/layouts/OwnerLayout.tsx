...
import { LayoutDashboard, Store, BarChart3, Users, CreditCard, LogOut, Plus, UtensilsCrossed, ChevronDown } from 'lucide-react';
    ...
    <div className="flex h-screen overflow-hidden">
      <aside className="w-60 shrink-0 bg-gradient-to-b from-own-700 to-own-900 text-white flex flex-col">
        ...
        <div className="shrink-0 p-3 border-t border-white/10 space-y-1.5">
          <button onClick={() => nav2('/own/restaurants')}
        ...
        <header className="h-12 bg-white border-b border-slate-200 px-6 flex items-center justify-between shrink-0">
          ...
          <div className="relative">
            <button onClick={() => setShowMenu(v => !v)}
              ...
              <span className="font-medium text-slate-700 max-w-[120px] truncate">{user?.name || owner?.name}</span>
